AFRAME.registerComponent('oak-tree', {
  init() {
    const children = `
      ...
      <a-cylinder radius="1.7" height="2" material="color: #888; opacity: 0; transparent: true;" position="0 3.4 0" trigger-cylinder="selector: [frisbee]; payload: 0.9;"></a-cylinder>
