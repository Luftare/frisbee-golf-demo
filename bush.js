AFRAME.registerComponent('bush', {
  init() {
    const children = `
      ...
      <a-cylinder radius="1" height="1.5" material="color: #888; opacity: 0.0; transparent: true;" position="0 -0.6 0" trigger-cylinder="selector: [frisbee]; payload: 0.9;"></a-cylinder>
    `;
