AFRAME.registerComponent('pine-tree', {
  init() {
    const children = `
      ...
      <a-cylinder visible="false" radius="1" height="3.5" material="color: #888; opacity: 0.0; transparent: true;" position="0 2.2 0" trigger-cylinder="selector: [frisbee]; payload: terrain;"></a-cylinder>
